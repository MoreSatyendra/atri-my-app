...
class Atri:
	def __init__(self, state: Any):
		...
		self.blogHeader = state["blogHeader"]
	...
	@property
	def blogHeader(self):
		self._getter_access_tracker["blogHeader"] = {}
		return self._blogHeader
	@blogHeader.setter
	def blogHeader(self, new_state):
		self._setter_access_tracker["blogHeader"] = {}
		global default_state
		self._blogHeader = Flex(new_state, default_state["blogHeader"])
